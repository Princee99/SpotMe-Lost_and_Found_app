...
class LostBottomSheet extends StatefulWidget {
  const LostBottomSheet({Key? key}) : super(key: key);

  @override
  _LostBottomSheetState createState() => _LostBottomSheetState();
}

class _LostBottomSheetState extends State<LostBottomSheet> {
  ...
  bool validateForm() {
    ...
    if (selectedImage == null) {
      _showErrorSnackBar(context, 'Please add an image of the lost item');
      return false;
    }
  ...
  Future<void> submitForm() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Lost item added successfully'),
